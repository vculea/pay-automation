...
## Playwright Tests pentru Sencha ExtJS

Acest proiect conține teste automatizate Playwright pentru site-ul Sencha ExtJS Kitchen Sink, în special pentru componenta Array Grid.
...
- **Sencha ExtJS Array Grid Tests** (`tests/sencha-array-grid.spec.js`)
